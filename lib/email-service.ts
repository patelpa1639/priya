          ...
          <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 25px;">
            ...
            <table style="width: 100%; border-collapse: collapse;">
              <tr>
                ...
                <td style="padding: 8px 0; color: #333;">${callData.id}</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td style="padding: 8px 0;">
                  <span style="background-color: ${callData.status === 'completed' ? '#10b981' : '#f59e0b'}; color: white; padding: 4px 12px; border-radius: 20px; font-size: 12px; font-weight: bold;">
                    ${callData.status}
                  </span>
                </td>
              </tr>
